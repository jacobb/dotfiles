# Generated by Powerlevel10k configuration wizard on 2024-01-22 at 01:15 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=071
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes.
    [[ VCS_STATUS_STASHES -ge 2 ]] && (( VCS_STATUS_STASHES )) && res+=" ${clean}*${VCS_STATUS_STASHES}"
